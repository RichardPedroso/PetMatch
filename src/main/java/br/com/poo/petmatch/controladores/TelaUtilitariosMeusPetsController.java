...
public class TelaUtilitariosMeusPetsController {

    public static final String FXML_PATH = "tela-utilitarios-meus-pets.fxml";
    ...
    private void mostrarAnimal(){
        animalAtual = PetMatch.cliente.animaisAdotadosCliente.get(indiceAtual);
    ...
    private void proximoAnimal(){
        if(indiceAtual < PetMatch.cliente.animaisAdotadosCliente.size()-1) {
            indiceAtual++;
            if (indiceAtual < PetMatch.cliente.animaisAdotadosCliente.size()) {
                animalAtual = PetMatch.cliente.animaisAdotadosCliente.get(indiceAtual);
                atualizarAnimal(animalAtual);
            }
        }else{
